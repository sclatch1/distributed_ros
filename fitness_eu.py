...
def fitnessEU(particle, robot_charge_duration, robots_coord, tasks, Charging_station, CHARGING_TIME):
    Energy_Harvesting_Rate=0
    num_jobs=4
    ...
    for job_index in range(num_jobs):
        ...
        for task_index in tasks_in_job:
            ...
            if robot_charge[robot] < 0.1*20*3600:
